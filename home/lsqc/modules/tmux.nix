  ...
  programs.tmux = {
    ...
    extraConfig = ''
      ...
      #      bind l select-pane -R
            ...
            set -g status-right '#[fg=#ffff00]#P#[default] | #{cpu_fg_color}cpu: #{cpu_percentage}#[default] | #[fg=#d61e96,bold]#{battery_percentage}%#[default] | #[fg=#1e2ad6]#{user}@#h#[default] | #[fg=white,bold]%H:%M#[default] '
